...
@section('title', '✏️ Sửa Size Sản phẩm')
...
<div class="card-clean">
    <h3><i class="bi bi-pencil-square"></i> Sửa Size Sản phẩm</h3>

    <form action="{{ route('admin.sizes.update', $size->id_size) }}" method="POST" id="size-form">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="name" class="form-label">Tên Size</label>
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                   value="{{ old('name', $size->name) }}" placeholder="Nhập tên size mới" >
