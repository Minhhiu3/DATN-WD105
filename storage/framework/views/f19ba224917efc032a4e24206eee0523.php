        ...
        <div class="row">
            ...
            <div class="col-lg-6 " >
                <div class="s_product_text" style="margin-left: 20px; margin-top: 20px;">
                    ...
                    <ul class="list">
                        <li><a href="<?php echo e(route('products', ['category' => $product->category->id_category])); ?>"><span>Danh mục</span>: <?php echo e($product->category->name_category ?? 'Chưa phân loại'); ?></a></li>
                    </ul>
