<?php $__env->startSection('title', 'Cài đặt tài khoản'); ?>
        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="<?php echo e(route('account.settings')); ?>">Cài đặt</a>
                </nav>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            ...
                            <a href="<?php echo e(route('account.settings')); ?>" class="list-group-item list-group-item-action active">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('account.profile')); ?>" class="btn btn-outline-primary btn-sm">
                                            Xem thông tin
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('account.change-password')); ?>" class="btn btn-outline-warning btn-sm">
                                            Đổi mật khẩu
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('account.orders')); ?>" class="btn btn-outline-success btn-sm">
                                            Xem đơn hàng
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <?php if($user->role && $user->role->name === 'Admin'): ?>
                                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-info btn-sm">
                                                Admin Panel
                                            </a>
                                        <?php else: ?>
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                <li><strong>Vai trò:</strong> <?php echo e($user->role ? $user->role->name : 'N/A'); ?></li>
                                <li><strong>Ngày tham gia:</strong> <?php echo e($user->created_at ? $user->created_at->format('d/m/Y') : 'N/A'); ?></li>
...
<?php echo $__env->make('layouts.client_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\OneDrive\Desktop\DATN_SU2025\ShoeMart_clone\DATN-WD105\resources\views/auth/settings.blade.php ENDPATH**/ ?>