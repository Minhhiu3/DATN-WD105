...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('sizes.store')); ?>" method="POST">
            ...
            <a href="<?php echo e(route('sizes.index')); ?>" class="btn btn-secondary">Quay lại</a>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\OneDrive\Desktop\DATN_SU2025\ShoeMart_New\DATN-WD105\resources\views/admin/size/create.blade.php ENDPATH**/ ?>